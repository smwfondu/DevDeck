export function applyTemplateThree(TemplateThreeColumnEl) {
    ...
    TemplateThreeColumnEl.appendChild(projectsEl);
    ...
    if (educations.innerText.trim()) {
        TemplateThreeColumnEl.appendChild(educations);
    }
    ...
    if (workExperiences.innerText.trim()) {
        TemplateThreeColumnEl.appendChild(workExperiences);
    }
    ...
    TemplateThreeColumnEl.appendChild(skillsDiv);
